...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets/img/logo-MAS-IT.png">
							...
							<div class="col-lg">
								<div class="p-5">
									<div class="text-center">
										<img src="<?php echo base_url() ?>assets/img/logo-MAS-IT.png" style="width: 80%"><br>
										<h1 class=" h2 text-center push-top-bottom animation-slideDown" style="color: black"><b></b></h1><br>
